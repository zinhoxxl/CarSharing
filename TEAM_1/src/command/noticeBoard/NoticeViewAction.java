...
public class NoticeViewAction implements ActionCommand {
	...
	public String action(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		nb = dao.getNoticeByNum(num,pageNum);
		//gbDto= (BbsGoodBadDTO)request.getAttribute("bbsGoodBad");
		//System.out.println("gbDto : " + gbDto.getNum());

		
		//상세페이지로 이동할때만 조회수 증가하게
		dao.updateNoticeReadcount(num);
		...
		request.setAttribute("bbs", nb);//글 정보
